 ...
 *
 * Disassembly of /Users/zhangtao/FX50J/DSDT/raw/SSDT-11.aml, Sun Jun 26 23:19:48 2016
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000019F7 (6647)
 *     Revision         0x01
 *     Checksum         0x0B
 *     OEM ID           "OptRef"
 ...
 */
DefinitionBlock ("/Users/zhangtao/FX50J/DSDT/raw/SSDT-11.aml", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store ("<<< GC6O >>>", Debug)
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0xC6), One))
            {
                Sleep (One)
            }
            ...
            \_SB.PCI0.PEG0.PEGP.SGPO (0x08, One)
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0xC6), Zero))
            {
                Sleep (One)
            }

            \_SB.PCI0.PEG0.PEGP.SGPO (0x08, Zero)
            Store (Zero, GC6M)
        ...
        {
            If (LEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0xC6), Zero))
            {
